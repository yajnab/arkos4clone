...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/home/ark/.quirks/"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/bin/ws2812"
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/bin/mcu_led"
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/sdljoytest"
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/sdljoymap"
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/console_detect"
...
safe   sudo chown -R 1002:1002 "$DST"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/lib/firmware/"rk915_*.bin 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/lib/firmware/aic8800DC" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/351Files/" 2>/dev/null
...
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/atomiswave.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/dreamcast.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/naomi.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/n64.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/pico8.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/drastic.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/drastic_kk.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/choose_drastic_ver.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/mediaplayer.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/get_last_played.sh" 2>/dev/null
...
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/dreamcast.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/naomi.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/saturn.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/n64.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/pico8.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/drastic.sh" 2>/dev/null
safe   sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/drastic_kk.sh" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/adckeys.py" 2>/dev/null
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/adckeys.sh" 2>/dev/null
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/etc/systemd/system/adckeys.service" 2>/dev/null
...
safe sudo chown -R 1002:1002 $MOUNT_DIR/root/home/ark/.config/retroarch/cores/*
safe sudo chown -R 1002:1002 $MOUNT_DIR/root/home/ark/.config/retroarch32/cores/*
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/etc/emulationstation/es_systems.cfg" 2>/dev/null
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/etc/emulationstation/es_systems.cfg.dual" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/bin/emulationstation/resources"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/bin/emulationstation/emulationstation"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/drastic" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/drastic-kk" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/lib/aarch64-linux-gnu/libjson-c.so"* 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/ppsspp/" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/flycastsa/" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/flycastsa-2022" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/scummvm/" 2>/dev/null
...
safe   sudo chown -R 1002:1002 "$WORK_DIR/tmproms/roms/tools/PortMaster"
safe   sudo chown -R 1002:1002 "$WORK_DIR/tmproms/roms/tools/PortMaster.sh"
...
safe   sudo chown -R 1002:1002 "$WORK_DIR/tmproms/roms/pymo/Scan_for_new_games.pymo"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/retrorun32"
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/retrorun"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/cpymo"
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/pymo.sh"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/ogage"
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/home/ark/.quirks/ogage"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/etc/systemd/system/351mp.service" 2>/dev/null
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/lib/systemd/system/mpv.service" 2>/dev/null
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/system/Advanced/"*.sh 2>/dev/null
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/Enable Quick Mode.sh" 2>/dev/null
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/Disable Quick Mode.sh" 2>/dev/null
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/Switch to main SD for Roms.sh" 2>/dev/null
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/usr/local/bin/Switch to SD2 for Roms.sh" 2>/dev/null
...
if [[ "$ARKOS_IMAGE_NAME" == *dArkOS* ]]; then
safe   sudo mkdir "$MOUNT_DIR/root/opt/system/Tools/"
...
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/system/"*.sh
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/system/Tools/"*.sh
safe sudo chown -R 1002:1002 "$MOUNT_DIR/root/opt/system/Advanced/"*.sh
